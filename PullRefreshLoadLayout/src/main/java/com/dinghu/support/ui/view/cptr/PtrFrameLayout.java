package com.dinghu.support.ui.view.cptr;
...
import com.dinghu.support.ui.view.cptr.indicator.PtrIndicator;
import com.dinghu.support.ui.view.cptr.loadmore.DefaultLoadMoreViewFooter;
import com.dinghu.support.ui.view.cptr.loadmore.GridViewHandler;
import com.dinghu.support.ui.view.cptr.loadmore.ILoadMoreViewFactory;
import com.dinghu.support.ui.view.cptr.loadmore.ILoadMoreViewFactory.ILoadMoreView;
import com.dinghu.support.ui.view.cptr.loadmore.ListViewHandler;
import com.dinghu.support.ui.view.cptr.loadmore.LoadMoreHandler;
import com.dinghu.support.ui.view.cptr.loadmore.OnLoadMoreListener;
import com.dinghu.support.ui.view.cptr.loadmore.OnScrollBottomListener;
import com.dinghu.support.ui.view.cptr.loadmore.RecyclerViewHandler;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    public void forceEndRefreshing() {
        if (mPtrHandler != null) {
            mPtrIndicator.onUIRefreshComplete();
            tryScrollBackToTopAfterComplete();
            tryToNotifyReset();
    ...
    public void resetFooterView() {
        if (null != mLoadMoreHandler) {
            hasInitLoadMoreView = mLoadMoreHandler.handleSetAdapter(
                    mContentView, mLoadMoreView, onClickLoadMoreListener);
        }
    }

    public void setFooterView(ILoadMoreViewFactory factory) {
        if (null == factory
                || (null != loadMoreViewFactory && loadMoreViewFactory == factory)) {
            return;
        }
    ...
    public void setLoadMoreEnable(boolean loadMoreEnable) {
        ...
        Log.i("TD", "setLoadMoreEnable:" + loadMoreEnable);
        ...
        if (!hasInitLoadMoreView && isLoadMoreEnable) {
            ...
            hasInitLoadMoreView = mLoadMoreHandler.handleSetAdapter(
                    mContentView, mLoadMoreView, onClickLoadMoreListener);
            mLoadMoreHandler.setOnScrollBottomListener(mContentView,
    ...
    public void setFooter2OnClickListener(OnClickListener listener) {
        if (mLoadMoreView != null) {//isLoadMoreEnable&& ())
            mLoadMoreView.setFooter2OnClickListener(listener);
        }
    }

    public void showFooter2(boolean isShow, String footer2Text) {
        if (mLoadMoreView != null) {//isLoadMoreEnable&& ())
            mLoadMoreView.showFooter2(isShow, footer2Text);
        }
    }
